...
➜ *See also the Deeps' [[#Cultures of The DEEPS the DEEPS|cultures]] and [[#the DEEPS (200)|tethers]].*
## the HEAVENS
...
➜ *See also the Heavens' [[#Cultures of the HEAVENS|cultures]] and [[#the HEAVENS (300)|tethers]].*
## the HELLS
...
➜ *See also the Hells' [[#Cultures of the HELLS|cultures]] and [[#the HELLS (400)|tethers]].*
## the WEFT
...
➜ *See also the Weft's [[#Cultures of the WEFT|cultures]] and [[#the WEFT (500)|tethers]].*
## the WILD
...
➜ *See also the Wild's [[#Cultures of the WILD|cultures]] and [[#the WILD (600)|tethers]].*
...
| **3** | Eastborne       | died of want or violence    |
...
| **2** | creeping grot     | a hunter’s kin            |
| **3** | eastern reach     | the Coastal Cities        |
| **4** | lost cities       | the Coastal Cities        |
...
| **3** | another time                                             | was exiled |
| **4** | another cosmos                                           | is hunting |
...
| :---: | --------------------------- | ------------------------------------------ | -------------------------------------------------------- |
| **1** | breathing amulet            | ash in your hair every morning             | funeral processions go out of their way to pass near you |
| **2** | forgotten ancestor’s spirit | dark moths fly from your mouth             | loud knocking                                            |
| **3** | spent phylactery            | necrotic ring finger                       | lost spirits congregate around you                       |
| **4** | telepathic skull            | you can read dead languages                | metal rusts at your touch                                |
...
|       | Link (10–20)                          | Mark (30–40)                           | Omen (50–60)                                   |
| :---: | ------------------------------------- | -------------------------------------- | ---------------------------------------------- |
| **1** | an eye in brine, always following you | embedded gem                           | a low, melodious call                          |
| **2** | barnacled key                         | gold dust in your fingerprints         | crones you've never met already know you       |
| **3** | blind, hairless burrow-thing          | forbidden craving                      | small offerings appear when you're not looking |
| **4** | lunatics                              | recurring dream                        | tremors                                        |
...
|       | Link (10–20)                                          | Mark (30–40)                             | Omen (50–60)                           |
| :---: | ----------------------------------------------------- | ---------------------------------------- | -------------------------------------- |
| **1** | berobed child                                         | astrological signs in your freckles      | beggars give you alms                  |
| **2** | blessed loaf, always fresh                            | hymnic earworm                           | candles flare when you pass            |
| **3** | book that opens itself                                | message of judgment or mercy to announce | doves flock around you                 |
| **4** | disciplinary bundle of eyes, mouths, and wings        | vestigial wings of mottled feathers      | rowdy children go quiet                |
...
|       | Link (10–20)         | Mark (30–40)                                            | Omen (50–60)                           |
| :---: | -------------------- | ------------------------------------------------------- | -------------------------------------- |
| **1** | a goat, staring      | always sweating                                         | distant screaming                      |
| **2** | bloody coin          | dried blood under your nails, impossible to scrub clean | domestic animals avoid you             |
| **3** | imp                  | flame under your tongue                                 | small misfortunes                      |
| **4** | iron ring            | no shadow                                               | sulphur smell                          |
...
|       | Link (10–20)                  | Mark (30–40)                                                | Omen (50–60)                                    |
| :---: | ----------------------------- | ----------------------------------------------------------- | ----------------------------------------------- |
| **1** | a lightning spider            | an older you tells you impossible secrets                   | children stop and stare, unblinking             |
| **2** | an attic in your pocket       | ever-present shimmer                                        | doors open to the wrong room                    |
| **3** | levitating stone              | immaterial arm                                              | mirrors near you reflect elsewheres             |
| **4** | puppet without a puppeteer    | wandering birthmark                                         | nearby puddles  birth small, short-lived things |
...
|       | Link (10–20)            | Mark (30–40)                                                                       | Omen (50–60)                                                |
| :---: | ----------------------- | ---------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| **1** | a hive, always swarming | bark in patches, instead of skin                                                   | leaves turn to face you                                     |
| **2** | carcasses               | compulsion to damage buildings                                                     | molted feathers                                             |
| **3** | mice                    | dragons in your eyes                                                               | sprouts grow from lumber                                    |
| **4** | river spirit            | shoes itch and chafe you                                                           | sudden change of season                                     |
| **5** | sacred tree             | your hair goes white and thick for winter, eyes change color in fall, and the like | wolves howl your name                                       |
...
**CUT LOOSE** (2B). Scene with another hunter, connection, or ally spending quality time together. Describe how the other party inspired you and take an ability from any role other than your own. [▷▷]

**LEVEL UP** (4H). Describe how recent events have changed you. Take a new ability from your role or gain +1 to Body, Heart, Mind or Beyond. [▷▷▷▷]
...
**WORK ON LONG-TERM PROJECT** (2H). When you work on a long-term project, describe what your hunter does to advance the project clock. Make a [[Swords Beyond online rules#FORTUNE ROLLS|fortune roll]] using a relevant stat and mark segments according to the results: 6- is one, 7-9 two, 10+ three, and double 6s is four.
...
**NPCs**
- **Commander Bova** (leader, *grizzled, prudent, family man*). 
- **Sub-Commander Nurnish** (second, *young, bright, addicted*).
- **Captain Farker** (Lost Plenty outpost leader, *coasting, vain, reactive*). 
- **Auxiliary-Captain Bronzehill** (Lost Plenty outpost, *conscientious, divided, moody*).
...
**NPCs**
- **Auditor Renslew** (overpaid for Lost Plenty office, *desperate, charming, showy*)
- **Tolltaker Lofgren** (lost Plenty to Dunhold road, *comfortable, predictable, indifferent*)
- **Notary Davies** (*tall, cunning, ambitious*)
...
**NPCs**
- **Pallister Olmaz** (leader of Lost Plenty monastery, *quiet, empathetic, sophisticated*)
- **Healer Quetza** (*eager, capable, outgoing*)
- **Herbalist Abiling** (*masterful, innovative, fearless*)
- **Evangelist Fex** (*exacting, secretive, noble family*)
- **Scribe Golaffson** (longest tenured at Lost Plenty monastery, *elderly, patient, shrewd*)
- **Infirmarian**
- **Lay staff** (locals; cook, guard, water children, unsworn novices)
